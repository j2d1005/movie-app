...
export const  updateCurrentPage= createAction(UPDATE_CURRENT_PAGE, current => current);
export const updateStartEndPage = createAction(UPDATE_START_END_PAGE, start => start, end => end );

// 초기 state 정의 
const initialState = {
    current : 1,  // 현재 선택된 페이지
    start : 0, //  페이지네이션 시작
    end : 10 // 페이지네이션 끝나는 페이지 넘버 
};
